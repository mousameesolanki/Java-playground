...
public class Demo {
    public static void run() {
        ...
        ConcertBookingSystem bookingSystem = ConcertBookingSystem.getInstacne();

        // Create concerts
        List<Seat> concert1Seats = generateSeats(100);
        Concert concert1 = new Concert("C001", "Artist 1", 1000.0, LocalDateTime.now().plusDays(30), LocalDateTime.now().plusHours(3),"Tarun",concert1Seats);
        bookingSystem.addConcert(concert1);

        List<Seat> concert2Seats = generateSeats(50);
        Concert concert2 = new Concert("C002", "Artist 2", 1003, LocalDateTime.now().plusDays(60),LocalDateTime.now().plusDays(60),"A R RAHMAN", concert2Seats);
        bookingSystem.addConcert(concert2);

        // Create users
        User user1 = new User("U001", "John Doe", "john@example.com",39590953);
        User user2 = new User("U002", "Jane Smith", "jane@example.com",938049543);
